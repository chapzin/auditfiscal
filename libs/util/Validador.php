...
class Validador
{
    ...
    public function validaDigitoNfe($chave, $base=9, $r=0)  {
        /**
         *   Autor:
         ...
         *
         *   Saída:
         *     Retorna a chave + digito verificador.
         *
         *   Observações:
    ...
    // Valida inscrição estadual do registro 0150
